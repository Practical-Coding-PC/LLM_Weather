...
from chatbot.weather_kma import (
    get_current_weather, 
...
# CCTV API 모듈 import
from chatbot.cctv_api import find_nearest_cctv, generate_cctv_html
...
# 초단기예보 CSV 파일에서 지역 키워드를 받아서, 행정구역 코드에 맞는 공식 명칭으로 변환하기 위한 dictionary.
# 예: "노원"이라고 입력하면 내부적으로 "노원구"로 바꿔 사용하고자 할 때 사용한다.
REGION_KEYWORDS = {
    "서울": "서울특별시",
    "춘천": "춘천시",
    "노원": "노원구",
...
if not CCTV_API_KEY:
    print("⚠️ CCTV_API_KEY가 설정되지 않았습니다! CCTV 기능을 사용할 수 없습니다.")
